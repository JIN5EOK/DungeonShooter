...
classDiagram
    ...
    class SkillData["SkillData : ScriptableObject<br>스킬 효과 리스트와 기타 정보"]{
        ...
        // EntitySkillGroup에 등록시 활성화 되는 이펙트
    ...
    class EntitySkillGroup["EntitySkillGroup<br>Entity의 스킬 모음"]{
...
- `SkillData` : 스킬의 동작 및 효과 정보, 스크립터블 오브젝트를 통해 편집
	...
	- `PassiveEffects` : 패시브 스킬 효과 리스트
		- `EntitySkillGroup`에 `RegistSkill`시 효과 실행
		- `EntitySkillGroup`에 `UnregistSkill`시 효과 제거
...
- `EntitySkillGroup` : 캐릭터의 고유 스킬들을 등록, 등록시 패시브 효과 적용
- `Skill` : 실제 스킬 인스턴스
