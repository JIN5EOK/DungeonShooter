...
namespace DungeonShooter
{
    ...
    public class StageSceneLifeTimeScope : LifetimeScope
    {
        protected override void Configure(IContainerBuilder builder)
        {
            ...
            builder.RegisterEntryPoint<PlayerLevelManager>(Lifetime.Scoped).AsSelf();
            ...
            builder.Register<PlayerStatusSession>(Lifetime.Scoped);
            builder.Register<PlayerSkillSession>(Lifetime.Scoped);
