...
namespace DungeonShooter
{
    ...
    public abstract class EffectBase
    {
        ...
        public virtual void Activate(IEntityContext context, SkillLevelData levelData)
        {
        ...
        public virtual void Deactivate(IEntityContext context, SkillLevelData levelData)
        {
            if (context == null || levelData == null)
